...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		FIND_LIBRARY(_OPENCL_32_LIBRARIES OpenCL.dll libOpenCL.a HINTS ${OPENCL_LIBRARY_SEARCH_PATHS} PATHS ${OPENCL_LIB_DIR} ENV PATH)
		FIND_LIBRARY(_OPENCL_64_LIBRARIES OpenCL.dll libOpenCL.a HINTS ${OPENCL_LIBRARY_64_SEARCH_PATHS} PATHS ${OPENCL_LIB_DIR} ENV PATH)
