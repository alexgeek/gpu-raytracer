...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		# Nvidia # doesnt work for mingw w64
		...
		FIND_LIBRARY(_OPENCL_32_LIBRARIES libOpenCL.a OpenCL.lib HINTS ${OPENCL_LIBRARY_SEARCH_PATHS} PATHS ${OPENCL_LIB_DIR} ENV PATH)
		FIND_LIBRARY(_OPENCL_64_LIBRARIES libOpenCL.a OpenCL.lib HINTS ${OPENCL_LIBRARY_64_SEARCH_PATHS} PATHS ${OPENCL_LIB_DIR} ENV PATH)
